...
# 77.45%, 87.55, 81.51, 67.79, 17.84, 27.69  # LM  modelpara-onlyLM-1.pth
# 74.62%, 86.64, 81.54, 46.09, 20.64, 31.17
# 77.20%, 87.08, 76.00, 65.45, 17.42, 27.78
# 71.07%, 82.75, 65.63, 62.07, 21.32, 36.42
...
# dir=r'.\parameter\modelpara-onlyLM-1.pth'
checkpoint = torch.load(dir)
CRNNmodel.load_state_dict(checkpoint['net'])
acc4 = testModel513N()
acc5 = testModelTS115()
